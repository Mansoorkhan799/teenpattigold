          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative w-full h-64 md:h-96 rounded-xl overflow-hidden mb-8">
              <Image
                ...
                alt="Create Teen Patti Gold Account and Login"
                fill
            ...
            <div className="prose prose-lg max-w-none">
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed">Launch the Teen Patti Gold app on your device. On the welcome screen, you'll see a "Register" button. Tap on it to begin the account creation process.</p>
                    </div>
                  </div>
              ...
              <div className="bg-secondary rounded-2xl shadow-xl p-8 md:p-12 mb-8">
                <h2 className="text-3xl font-bold mb-8 text-white">How to Login to Your Teen Patti Gold Account</h2>
                ...
                <div className="space-y-8">
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold mb-3 text-white">Open the Teen Patti Gold App</h3>
                      <p className="text-gray-300 leading-relaxed">Launch the Teen Patti Gold app on your Android device.</p>
                    </div>
                  </div>
              ...
              <div className="bg-secondary rounded-2xl shadow-xl p-8 md:p-12 mb-8">
                ...
                <ul className="space-y-4 text-gray-300">
                  ...
                  <li className="flex items-start">
                    ...
                    <span><strong>Don't Share Your Credentials:</strong> Never share your mobile number or password with anyone, even if they claim to be from Teen Patti Gold support.</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-orange-500 mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span><strong>Update Regularly:</strong> Keep the Teen Patti Gold app updated to the latest version to benefit from security improvements.</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-orange-500 mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              ...
              <div className="bg-secondary rounded-2xl shadow-xl p-8 md:p-12 mb-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[#0A1029] rounded-xl p-6">
                    ...
                    <p className="text-gray-300 leading-relaxed">If you're not receiving OTP messages, check your network connection, ensure your mobile number is correct, or try requesting a new OTP. Contact Teen Patti Gold support if the problem persists.</p>
                  </div>
                </div>
              </div>
