                ...
                <div className="bg-[#0A1029] rounded-xl p-6 border border-accent">
                  ...
                  <ul className="space-y-3 text-gray-300">
                    <li className="flex items-start">
                      ...
                      <span>Teen Patti Gold is a card game that may involve <strong>real money</strong> when played on certain platforms.</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-accent mr-2 font-bold">•</span>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "Disclaimer - Teen Patti Gold",
            "description": "Legal disclaimer and important information about Teen Patti Gold website.",
            "url": "https://teenpattigoldgame.com.pk/disclaimer"
          })
        }}
      />
