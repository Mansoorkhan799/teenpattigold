...
export const META_HOME_TITLE =
  'Teen Patti Gold Pakistan | Official APK v1.656 Free';

export const META_HOME_DESCRIPTION =
  'Download Teen Patti Gold APK for Pakistan. Play 30+ card games, earn real cash, and withdraw fast with JazzCash & EasyPaisa. Official v1.656 — secure & free.';
